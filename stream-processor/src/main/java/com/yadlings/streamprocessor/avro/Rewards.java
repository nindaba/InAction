...
public class Rewards extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Rewards(java.lang.Long customerId, java.lang.Double currentPoints, java.lang.Double total, java.lang.Long timePurchase) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: timePurchase = (java.lang.Long)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static com.yadlings.streamprocessor.avro.Rewards.Builder newBuilder() {
    return new com.yadlings.streamprocessor.avro.Rewards.Builder();
  }
   ...
   * @return A new Rewards RecordBuilder
   */
  public static com.yadlings.streamprocessor.avro.Rewards.Builder newBuilder(com.yadlings.streamprocessor.avro.Rewards.Builder other) {
    if (other == null) {
      return new com.yadlings.streamprocessor.avro.Rewards.Builder();
    } else {
      return new com.yadlings.streamprocessor.avro.Rewards.Builder(other);
    }
  }
   ...
   * @return A new Rewards RecordBuilder
   */
  public static com.yadlings.streamprocessor.avro.Rewards.Builder newBuilder(com.yadlings.streamprocessor.avro.Rewards other) {
    if (other == null) {
      return new com.yadlings.streamprocessor.avro.Rewards.Builder();
    } else {
      return new com.yadlings.streamprocessor.avro.Rewards.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Rewards>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.yadlings.streamprocessor.avro.Rewards.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[3], other.timePurchase)) {
        this.timePurchase = data().deepCopy(fields()[3].schema(), other.timePurchase);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.yadlings.streamprocessor.avro.Rewards other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.customerId)) {
        this.customerId = data().deepCopy(fields()[0].schema(), other.customerId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yadlings.streamprocessor.avro.Rewards.Builder setCustomerId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yadlings.streamprocessor.avro.Rewards.Builder clearCustomerId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yadlings.streamprocessor.avro.Rewards.Builder setCurrentPoints(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yadlings.streamprocessor.avro.Rewards.Builder clearCurrentPoints() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yadlings.streamprocessor.avro.Rewards.Builder setTotal(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yadlings.streamprocessor.avro.Rewards.Builder clearTotal() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yadlings.streamprocessor.avro.Rewards.Builder setTimePurchase(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yadlings.streamprocessor.avro.Rewards.Builder clearTimePurchase() {
    ...
    public Rewards build() {
      try {
        ...
        record.timePurchase = fieldSetFlags()[3] ? this.timePurchase : (java.lang.Long) defaultValue(fields()[3]);
        return record;
